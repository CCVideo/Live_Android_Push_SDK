 ...
 * @since 2.0.0
 */
public abstract class NewBasePopupWindow implements View.OnClickListener {
     ...
     * @param context 上下文
     */
    public NewBasePopupWindow(Context context) {
        this(context, 0, 0);
    }
     ...
     */
    public NewBasePopupWindow(Context context, int width, int height) {
        mContext = context;
