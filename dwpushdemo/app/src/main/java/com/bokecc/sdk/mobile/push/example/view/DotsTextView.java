...
public class DotsTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void hide() {
        ...
        dotTwoMoveRightToLeft.addListener(new Animator.AnimatorListener() {
            @Override
    ...
    public void hideAndStop(OnAnimEndListener listener) {
        mOnAnimEndListener = listener;
        hide();
        stop();
    }
